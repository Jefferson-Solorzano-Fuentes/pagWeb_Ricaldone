...
if (isset($_GET[ACTION])) {
    ...
    switch ($_GET[ACTION]) {
        ...
        case READ_NOMBRECATEGORIA:
            if ($result[DATA_SET] = $detalle_producto->readNombreCategoria()) {
