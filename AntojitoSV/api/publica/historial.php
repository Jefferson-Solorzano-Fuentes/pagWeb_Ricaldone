...
if (isset($_GET[ACTION])) {
    ...
    switch ($_GET[ACTION]) {
        ...
        case SEARCH:
                ...
                if (!$pedido->setFechaInicio($_POST[FECHA_INICIO])) {
                    $result[MESSAGE] = 'Fecha inicial incorrecta';
                } elseif (!$pedido->setFechaFinal($_POST[FECHA_FINAL])) {
                    $result[MESSAGE] = 'Fecha final incorrecto';
                } elseif ($result[DATA_SET] = $pedido->searchRowsHistorial($_POST[SEARCH])) {
                    $result[STATUS] = SUCESS_RESPONSE;
