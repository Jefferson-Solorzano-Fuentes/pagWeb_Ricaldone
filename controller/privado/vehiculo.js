...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    await readRows(API_VEHICULO, CRUD_NAME)
...
getElementById('agregar_nuevo_registro').addEventListener('submit', async (event) => {
    ...
    // API REQUEST
    await saveRow(API_VEHICULO, API_UPDATE, parameters, CRUD_NAME);
});
...
getElementById('delete-form').addEventListener('submit', async (event) => {
    ...
    //API REQUEST
    await deleteRow(API_VEHICULO, parameters, CRUD_NAME);
});
