...
if (isset($_GET[ACTION])) {
    ...
    switch ($_GET[ACTION]) {
        ...
        case CREATE:
            ...
            } else if (!$proveedor->setTelefono($_POST[TELEFONO])){
                $result[EXCEPTION] = 'Número de Telefono no valido';
            } else if (!$proveedor->setCorreo($POST[CORREO])) {
                $result[EXCEPTION] = 'Correo electronico no valido';
            } else if (!$proveedor->setDireccion($POST[DIRECCION])){
                $result[EXCEPTION] = 'Direccion incorrecta';
            } else if (!$proveedor->setEstado($POST[ESTADO])){
        ...
        case UPDATE:
            ...
            if (!$proveedor->setId($_POST[ID])) {
                $result[EXCEPTION] = 'Proveedor incorrecto';
            } else if(!$proveedor->setNombre($_POST[NOMBRE])) {
                $result[EXCEPTION] = 'Nombre incorrecto';
            } else if (!$proveedor->setTelefono($_POST[TELEFONO])){
                $result[EXCEPTION] = 'Número de Telefono no valido';
            } else if (!$proveedor->setCorreo($POST[CORREO])) {
